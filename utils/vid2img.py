...
def vid2img(src='.', gap=1, rot=0): # rot=(0,1,2,3)
    for v in glob('%s/*.mp4'%src):
        ...
        dst = v[:-4]; dd = os.path.basename(dst)
        ...
        '''while True:
            ...
            cv2.imwrite(dst+'/%s_%06d.jpg'%(dd,i), im)'''
