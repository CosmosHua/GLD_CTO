...
parser.add_argument('--resume', default='interrupt', type=str,
...
parser.add_argument('--validation_epoch', default=10, type=int, help='Output validation information every n iterations. If -1, do no validation.')
