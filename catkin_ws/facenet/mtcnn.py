...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            if type(pretrained)!=str: pretrained = '../data/pnet.pt'
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            if type(pretrained)!=str: pretrained = '../data/rnet.pt'
            state_dict_path = os.path.join(os.path.dirname(__file__), pretrained)
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            if type(pretrained)!=str: pretrained = '../data/onet.pt'
            state_dict_path = os.path.join(os.path.dirname(__file__), pretrained)
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class MTCNN(nn.Module):
    ...
    def __init__(self, image_size=160, margin=0, min_face_size=20,
        ...
        if device.type=='cuda': print(f'MTCNN: {torch.cuda.get_device_name()}')
    ...
    def forward(self, img, save_path=None, landmarks=False):
        ...
        if not landmarks: return faces, batch_boxes, batch_probs
    ...
    def detect(self, img, landmarks=False):
        ...
        if not landmarks: return boxes, probs
